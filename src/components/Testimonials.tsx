  ...
  return (
    <section id="testimonials" className="py-32 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollReveal>
          <h2 className="text-4xl md:text-5xl  text-center font-[var(--heading-font)] text-gray-800 mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <ScrollReveal key={index} className={`delay-${index * 200}`}>
              <div className="bg-white p-8 rounded-3xl shadow-lg transform transition-all duration-300 hover:-translate-y-2">
              ...
              <div
              className='bg-[#C0A080] bg-opacity-20 p-8 rounded-3xl transform transition-all duration-300 hover:-translate-y-2'
              >
              <img 
