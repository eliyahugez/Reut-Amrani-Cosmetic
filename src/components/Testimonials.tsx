          ...
          {testimonials.map((testimonial, index) => (
            <ScrollReveal key={index} className={`delay-${index * 200}`}>
              <div className="bg-white p-3 rounded-3xl shadow-lg transform transition-all duration-300 hover:-translate-y-2">
                ...
                <p className="text-gray-700 text-md mb-6 text-center leading-relaxed">{testimonial.text}</p>
                <p className="text-[#C0A080] font-medium text-center text-xl">{testimonial.name}</p>
              <div
              className='bg-[#C0A080] bg-opacity-20 p-2 rounded-3xl transform transition-all duration-300 hover:translate-y-2 hover:shadow-lg'
              >
              <img 
